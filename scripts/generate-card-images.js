...
//
//    src/main/resources/img/cards/originals
//
...
//
//     src/main/resources/img/cards/generated/*.png
//
...
const resourcesPath = '/src/main/resources/img/cards';
const inputDirectory = path.join(__dirname, `..${resourcesPath}/originals`);
const outputDirectory = path.join(__dirname, `..${resourcesPath}/generated`);
const srcDirectory = path.join(__dirname, '../src/main/java/com/ms813/sts/hermetic/cards');
