...
import com.ms813.sts.hermetic.alchemy.coagulate.CoagulateActions;
...
public class CoagulateAction extends AbstractGameAction {

    public CoagulateAction(
    ...
    public void update() {
        ...
        final AlchemyTuple tuple = CoagulateActions.instance.apply(aether, sanguis, target, source);

        final AurumPower aurum = (AurumPower) target.getPower(AurumPower.POWER_ID);
        if (aurum != null) {
            CoagulateActions.instance.apply(aurum, target, source);
        }
